...
citizenHeading: { signin: 'Welcome back', signup: 'Create your account' },
    citizenSub: {
      signin: 'Sign in with your email — no password to remember.',
    ...
    emailHelper: "We'll send a 6-digit code to your email.",
    sendCode: 'Send code',
    otpHeading: 'Enter the code',
    otpSub: 'We sent a 6-digit code by email to',
  ...
  bn: {
    ...
    citizenSub: {
      signin: 'ইমেইল দিয়েই প্রবেশ — কোনো পাসওয়ার্ড মনে রাখতে হবে না।',
    ...
    emailHelper: 'আপনার ইমেইলে ৬ ডিজিটের একটি কোড পাঠানো হবে।',
    sendCode: 'কোড পাঠান',
    otpHeading: 'কোডটি লিখুন',
    otpSub: '৬ ডিজিটের কোডটি ইমেইলে পাঠানো হয়েছে',
    changeNumber: 'ইমেইল বদলান',
  ...
  hi: {
    ...
    citizenSub: {
      signin: 'ईमेल से लॉगिन करें — कोई पासवर्ड याद रखने की ज़रूरत नहीं।',
    ...
    emailHelper: 'आपके ईमेल पर 6 अंकों का कोड भेजा जाएगा।',
    sendCode: 'कोड भेजें',
    otpHeading: 'कोड दर्ज करें',
    otpSub: '6 अंकों का कोड ईमेल से इस पते पर भेजा गया है',
